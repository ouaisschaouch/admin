...
<div class="container">
    ...
    <table>
        <tr>
            <td>Id product</td>
            <td><input type="text"   value="<?php echo $_GET['id'] ;?>" disabled ></td>
        ...
        <tr>
            ...
            <td><input type="text" name="Quantity_in_Stock" ></td>
        ...
        <tr>
                    ...
                    <td><input type="hidden" name="ancien_size" value="<?php echo $_GET['size']; ?>"></td>
